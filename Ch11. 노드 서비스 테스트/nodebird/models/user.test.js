// Unit-test code for testing 'User' model (to achieve 100% test coverage)
const Sequelize = require('sequelize');
const User = require('./user');
const config = require('../config/config').test;

// Q. Does this create a new test database?
// → No, 'sequelize' instance is only used for 'init' function unit-testing
